...
# for year in 2000 2001; do
  ...
  echo $year" ${variable} data being collected + each year merged"
...
echo "${variable} data collected + merged!"
echo "${variable} Merge collect time taken: "`date -u -d @${seconds_elapsed} +"%T"`
