...
def open_pred_data(model: str, experiment: str = "one_month_forecast"):
    ...
    files = [
        f for f in (data_dir / "models" / "one_month_forecast" / model).glob("*.nc")
    ]
...
# )
plot_model_spatial_rmse(
    model="persistence", model_rmse=persistence_rmse_da, vmin=vmin, vmax=vmax
)
# plot_model_spatial_rmse(
...
#     vmin=vmin, vmax=vmax
# )
plot_model_spatial_rmse(model="ealstm", model_rmse=ealstm_rmse_da, vmin=vmin, vmax=vmax)

vmin, vmax = get_vrange(
    drop_nans_and_flatten(ealstm_rmse_da - persistence_rmse_da),
    drop_nans_and_flatten(ealstm_rmse_da - persistence_rmse_da),
)
plot_model_spatial_rmse(
    model="ealstm",
    model_rmse=ealstm_rmse_da - persistence_rmse_da,
    vmin=vmin,
    vmax=vmax,
)
...
vmin = -0.1
vmax = 0.7
plot_model_spatial_r2(model="ealstm", model_r2=ealstm_r2_da, vmin=vmin, vmax=vmax)
plot_model_spatial_r2(
    model="persistence", model_r2=persistence_r2_da, vmin=vmin, vmax=vmax
)

# plot teh difference
vmin, vmax = get_vrange(
    drop_nans_and_flatten(ealstm_r2_da - persistence_r2_da),
    drop_nans_and_flatten(ealstm_r2_da - persistence_r2_da),
)
...
plot_model_spatial_r2(
    model="ealstm - persistence",
    model_r2=ealstm_r2_da - persistence_r2_da,
    vmin=vmin,
    vmax=vmax,
    cmap="RdBu",
)
...
ax.set_ylabel("Density")
fig.savefig(
    Path("/Users/tommylees/Downloads") / "model_intercomparison_histograms_r2.png"
)
...
sns.distplot(
    drop_nans_and_flatten(ealstm0_rmse_da), ax=ax, label="ealstm_surrounding_0"
)
