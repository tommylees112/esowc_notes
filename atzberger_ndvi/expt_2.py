...
if __name__ == '__main__':
    ...
    expts_to_run = [
        ...
        ['VCI', 'precip'], ['VCI', 't2m'], ['VCI', 'pev'], ['VCI', 'E'], ['VCI', 'SMsurf'], ['VCI', 'SMroot'],
        ['VCI', 'precip', 't2m'], ['VCI', 'precip', 'pev'], ['VCI', 'precip', 'E'], ['VCI', 'precip', 'SMsurf'], ['VCI', 'precip', 'SMroot'],
        ['VCI', 'precip', 't2m', 'pev'], ['VCI', 'precip', 't2m', 'E'], ['VCI', 'precip', 't2m', 'SMsurf'], ['VCI', 'precip', 't2m', 'SMroot'],
        ['VCI', 'precip', 't2m', 'pev', 'E'], ['VCI', 'precip', 't2m', 'pev', 'SMsurf'], ['VCI', 'precip', 't2m', 'pev', 'SMroot'],
        ['VCI', 'precip', 't2m', 'pev', 'E', 'SMsurf'], ['VCI', 'precip', 't2m', 'pev', 'E', 'SMroot'],
        ['VCI', 'precip', 't2m', 'pev', 'E', 'SMsurf', 'SMroot']
    ]
